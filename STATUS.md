...
| Test suite | ✅ 922 app tests + 44 core tests; `flutter analyze` at 2 pre-existing style hints in test files; Windows release and debug APK both build from one tree |
